...
<section class="sub-reason-top">
    <div class="sub-reason-top__inner inner">
        <div class="sub-reason-top__contents fade-in">
            ...
            <p class="sub-reason-top__text">私たちは、「リフォームやリノベーションってどこに頼めばいいの？」と<br>お悩みの方のための、 身近で気軽に相談できる街のリフォーム屋さんです。<br>「こんな小さなことでもいいのかな？」「予算が決まってないけど大丈夫？」<br>「どんなリフォームがいいのか分からない…」など<br>おうちのお悩みを、気軽に話せる雰囲気を大切にしています。<br>そんな “ちょっとしたお困りごと” や “お家の未来の相談” に、<br>私たちがしっかり寄り添い、理想の住まいづくりを全力でサポートします。<br>「ちょっと話を聞いてみたいな」「まだ決めてないけど相談していい？」などの相談からでももちろん大歓迎！<br>いつでも、どんなことでも、お気軽にご相談ください。</p>
            <div class="sub-reason-top__img"><div class="fade-in"><img src="<?php echo get_template_directory_uri(); ?>/dist/assets/images/reason/img.webp" alt="相談する様子のイメージ画像" width="" height="" loading="lazy" decoding="async"></div></div>
        </div>
    </div>
</section>
        ...
        <div class="sub-reason__body">
            <ul class="sub-reason__list">
                <li class="sub-reason__item">
                    <div class="sub-reason__photo fade-in"><img src="<?php echo get_template_directory_uri(); ?>/dist/assets/images/reason/photo1.webp" alt="親身に相談に乗る様子のイメージ画像" width="" height="" loading="lazy" decoding="async"></div>
                    ...
                    <div class="sub-reason__deco fade-in"><img src="<?php echo get_template_directory_uri(); ?>/dist/assets/images/reason/deco1.webp" alt="気軽に相談できるイラスト画像" width="" height="" loading="lazy" decoding="async"></div>
                </li>
                <li class="sub-reason__item sub-reason__item--reserve">
                    <div class="sub-reason__photo fade-in"><img src="<?php echo get_template_directory_uri(); ?>/dist/assets/images/reason/photo2.webp" alt="すぐに駆けつける様子のイメージ画像" width="" height="" loading="lazy" decoding="async"></div>
                    <div class="sub-reason__contents fade-in">
                        <div class="sub-reason__subTl">
                    ...
                    <div class="sub-reason__deco fade-in"><img src="<?php echo get_template_directory_uri(); ?>/dist/assets/images/reason/deco2.webp" alt="すぐに駆けつける様子のイラスト画像" width="" height="" loading="lazy" decoding="async"></div>
                </li>
                <li class="sub-reason__item">
                    <div class="sub-reason__photo fade-in"><img src="<?php echo get_template_directory_uri(); ?>/dist/assets/images/reason/photo3.webp" alt="お得なメージ画像" width="" height="" loading="lazy" decoding="async"></div>
                    <div class="sub-reason__contents fade-in">
                        <div class="sub-reason__subTl">
