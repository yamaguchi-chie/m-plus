   ...
   <header class="header js-header">
    ...
    <nav class="sp-nav">
      ...
      <ul class="sp-nav__items">
        <li class="sp-nav__item"><a href="<?php echo esc_url(home_url()); ?>">TOPへ</a></li>
        ...
        <li class="sp-nav__item"><a href="<?php echo esc_url(home_url("news")); ?>">新着情報一覧</a></li>
    ...
    <div class="fixd-cta">
      <h4 class="fixd-cta__title"><img src="<?php echo get_template_directory_uri(); ?>/dist/assets/images/common/cta-title.webp" alt="contact" loading="lazy" decoding="async"></h4>
