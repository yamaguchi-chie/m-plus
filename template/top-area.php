            ...
            <div class="top-area__box">
                ...
                <div class="top-area__contents fade-in">
                    ...
                    <div class="top-area__top">
                        <h4 class="top-area__subTl"><img src="<?php echo get_template_directory_uri(); ?>/dist/assets/images/top/area/subTl1.webp" alt="" loading="lazy" decoding="async"></h4>
                        <p class="top-area__area-txt1"><span>愛知県</span>・<span>岐阜県</span>・<span>三重県</span></p>
                    </div>
                    <div class="top-area__bottom fade-in">
                        <div class="top-area__line">
                            <h4 class="top-area__subTl top-area__subTl--orange"><img src="<?php echo get_template_directory_uri(); ?>/dist/assets/images/top/area/subTl2.webp" alt="" loading="lazy" decoding="async"></h4>
                        </div>
