...
<section class="top-flow">
    <div class="top-flow__inner inner">
        <div class="top-flow__top">
            <h2 class="top-flow__title">リフォームの流れ</h2>
            <p class="top-flow__en">flow</p>
        </div>
        <p class="top-flow__catch">お客様のご相談をお聞きした上で、現地調査を行いながらプランをご提案いたします。<br>自社施工なので、お引渡しからアフターフォローまで安心してお任せいただけます。</p>
        <div class="top-flow__body">
            <div class="top-flow__contents">
                <div class="top-flow__deco"><img src="<?php echo get_template_directory_uri(); ?>/dist/assets/images/top/flow-deco.webp" alt="" width="" height="" loading="lazy" decoding="async"></div>
                <div class="top-flow__btn">
                    <a href="<?php echo esc_url(home_url("flow")); ?>" class="top-btn top-btn--flow"><span>ご依頼までの流れ</span></a>
                </div>
            </div>
            <div class="top-flow__img"><img src="<?php echo get_template_directory_uri(); ?>/dist/assets/images/top/flow-img.webp" alt="" width="" height="" loading="lazy" decoding="async"></div>
        </div>
    </div>
</section>
...
<section class="top-area">
    <div class="top-area__inner inner">
        <div class="top-area__body">
            <h3 class="top-area__title">対応地域</h3>
            <div class="top-area__box">
                <div class="top-area__deco"><img src="<?php echo get_template_directory_uri(); ?>/dist/assets/images/top/area/area.webp" alt="" width="" height="" loading="lazy" decoding="async"></div>
                <div class="top-area__contents">
                    <p class="top-area__txt">名古屋市を中心に愛知県や<br>東海エリアの幅広いエリアにも対応中！</p>
                    <div class="top-area__top">
                        <h4 class="top-area__subTl">東海エリア</h4>
                        <p class="top-area__area-txt1"><span>愛知県</span>・<span>岐阜県</span>・<span>三重県</span></p>
                    </div>
                    <div class="top-area__bottom">
                        <div class="top-area__line">
                            <h4 class="top-area__subTl top-area__subTl--orange">愛知エリア</h4>
                        </div>
                        <p class="top-area__area-txt2">名古屋市(緑区・中村区・中区・南区・北区・千種区・昭和区・中川区・瑞穂区)・春日井市・小牧市・一宮市・北名古屋市・稲沢市東海市・大府市・豊田市・岡崎市・豊明市・知立市・半田市・知多市・常滑市・愛西市・蟹江市・津島市・など</p>
                    </div>
                </div>
            </div>
        </div>
