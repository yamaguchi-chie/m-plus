        ...
        <ul class="flow__list">
            <li class="flow__item fade-in">
                <article class="flow__wrap">
                    ...
                    <div class="flow__body">
                        <div class="flow__img"><img src="<?php echo get_template_directory_uri(); ?>/dist/assets/images/flow/1.webp" alt="話を聞く様子のイメージ画像" width="" height="" loading="lazy" decoding="async"></div>
            ...
            <li class="flow__item fade-in">
                <article class="flow__wrap">
                    ...
                    <div class="flow__body">
                        <div class="flow__img"><img src="<?php echo get_template_directory_uri(); ?>/dist/assets/images/flow/2.webp" alt="一緒に考える様子のイメージ画像" width="" height="" loading="lazy" decoding="async"></div>
            ...
            <li class="flow__item fade-in">
                <article class="flow__wrap">
                    ...
                    <div class="flow__body">
                        <div class="flow__img"><img src="<?php echo get_template_directory_uri(); ?>/dist/assets/images/flow/3.webp" alt="現地を調査している様子のイメージ画像" width="" height="" loading="lazy" decoding="async"></div>
            ...
            <li class="flow__item fade-in">
                <article class="flow__wrap">
                    ...
                    <div class="flow__body">
                        <div class="flow__img"><img src="<?php echo get_template_directory_uri(); ?>/dist/assets/images/flow/4.webp" alt="プランを作成している様子のイメージ画像" width="" height="" loading="lazy" decoding="async"></div>
            ...
            <li class="flow__item fade-in">
                <article class="flow__wrap">
                    ...
                    <div class="flow__body">
                        <div class="flow__img"><img src="<?php echo get_template_directory_uri(); ?>/dist/assets/images/flow/5.webp" alt="契約をしている様子のイメージ画像" width="" height="" loading="lazy" decoding="async"></div>
            ...
            <li class="flow__item fade-in">
                <article class="flow__wrap">
                    ...
                    <div class="flow__body">
                        <div class="flow__img"><img src="<?php echo get_template_directory_uri(); ?>/dist/assets/images/flow/7.webp" alt="新たなくらいをイメージした画像" width="" height="" loading="lazy" decoding="async"></div>
