...
<section class="sub-flow-top">
    <div class="sub-flow-top__inner inner">
        ...
        <div class="sub-flow-top__img"><img src="<?php echo get_template_directory_uri(); ?>/dist/assets/images/top/flow-img.webp" alt="" width="" height="" loading="lazy" decoding="async"></div>
    </div>
</section>
