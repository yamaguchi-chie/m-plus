...
?>
<section class="sub-mv js-mv <?php if (is_page('company')) {
    echo 'sub-mv--company';
} ?>">
...
<div class="sub-company">
    <div class="sub-company__inner inner">
        <div class="sub-company__body">
            <div class="sub-company__contents fade-in">
            ...
            <div class="sub-company__img fade-in"><img src="<?php echo get_template_directory_uri(); ?>/dist/assets/images/top/area/area-img.webp" alt="" width="" height="" loading="lazy" decoding="async"></div>
        </div>
    </div>
</div>
...
<section class="concept" id="concept">
    ...
    <div class="concept__title fade-in">
            <h2 class="simple-Tl">経営理念</h2>
        </div>
        <div class="concept__body">
            <h3 class="concept__subTl fade-in">「義を見てせざるは勇無きなり」</h3>
            <ul class="concept__list fade-in">
...
<section class="overview" id="overview">
    ...
    <div class="overview__title fade-in">
...
<section class="access" id="access">
    <div class="access__inner inner">
        <div class="access__title fade-in">
            <h2 class="simple-Tl">アクセス</h2>
        </div>
        <div class="access__wrap fade-in">
        ...
        <p class="access__txt fade-in">〒462-0825 愛知県名古屋市北区大曽根3-10-7</p>
    </div>
</section>
